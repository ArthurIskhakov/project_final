...
#
#         time_on_site = game.find('span', class_='data') \
#             .find('span', class_='font-1rem')
#         time = time_on_site.text.replace("\n", "").replace(" ", "")
#
#         game_status_on_site = game.find('span', class_='status finished')
#
#         game_minute = game. \
...
#                         '\n' + ' ' + '\n'
#             else:
#                 score_home = game.find('div', class_='main-score'). \
#                     find('span', class_='point scoreHost'). \
#                     text.replace("\n", "").replace(" ", "")
#                 score_guest = game.find('div', class_='main-score'). \
#                     find('span', class_='point scoreGuest'). \
#                     text.replace("\n", "").replace(" ", "")
#                 games = games + \
#                         f'Время начала матча: {time}' \
#                         + '\n' + f'Минута: {game_minute.text}' \
...
#
#         else:
#             game_status = game_status_on_site. \
#                 text.replace("\n", "").replace(" ", "")
#             score_home = game.find('div', class_='main-score'). \
#                 find('span', class_='point scoreHost'). \
#                 text.replace("\n", "").replace(" ", "")
